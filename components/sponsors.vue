<template>
  <div class="content">
    <div class="support size margin">
      <div
        class="support--block justify-content-center container column"
        id="sponsors"
      >
        <div class>
          ...
          <ul class="support--list list-style-none">
            <li
              class="support--item"
              v-for="sponsor in getSponsorByType('diamond')"
              :key="sponsor.id"
            >
              <a v-bind:href="sponsor.address">
                <img
                  class="support--image diamond"
                  v-bind:src="
                    require(`@/assets/images/sponsors/${sponsor.image}.png`)
                  "
          ...
          <ul class="support--list list-style-none">
            <li
              class="support--item"
              v-for="sponsor in getSponsorByType('silver')"
              :key="sponsor.id"
            >
              <a v-bind:href="sponsor.address">
                <img
                  class="support--image silver"
                  v-bind:src="
                    require(`@/assets/images/sponsors/${sponsor.image}.png`)
                  "
                  v-bind:alt="sponsor.name"
          ...
          <div class="container align-center margin-top-50">
            <a
              href="/conf/pdf/mediakit.pdf"
              target="_blank"
              class="btn btn-primary btn-outline margin"
